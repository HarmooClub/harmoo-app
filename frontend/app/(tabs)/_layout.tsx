...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="messages" listeners={guardedListener} options={{ tabBarIcon: ({ color, focused }) => <TabIcon name={focused ? 'chatbubble' : 'chatbubble-outline'} focused={focused} color={color} /> }} />
